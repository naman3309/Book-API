...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        builder.Services.AddIdentity<ApplicationUser, IdentityRole>().AddEntityFrameworkStores<BookStoreDB>().AddDefaultTokenProviders();//error 500 internal server to be rewiew later
